    ...
    <div class="container fixed h-full relative">
        <header class="absolute h-14 w-full rounded-b-3xl bg-gradient-to-r from-[#F9DED5] to-[#FCEDE8] shadow-xl overflow-hidden">
            <div class="h-full flex text-2xl text-gray-700 items-center">
                <div class="nav-item select-nav-item flex justify-center items-center cursor-pointer h-full w-1/4 ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 nav-svg select-nav-svg stroke-gray-700">
                ...
                <div class="nav-item flex justify-center items-center cursor-pointer h-full w-1/4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 nav-svg stroke-gray-700">
