    ...
    <div class="container fixed h-full relative">
        <header class="absolute h-14 w-full rounded-b-3xl bg-gradient-to-r from-[#F9DED5] to-[#FCEDE8] shadow-xl overflow-hidden">
            <div class="h-full flex text-2xl text-gray-700 items-center">
                <div data-link="{{ route('home') }}" class="questionnaires nav-item {{ $active !== 'questionnaires' ?: 'select-nav-item' }}  flex justify-center items-center cursor-pointer h-full w-1/4 ">
                ...
                <div data-link="{{ route('home') }}" class="likes nav-item {{ $active !== 'likes' ?: 'select-nav-item' }} flex justify-center items-center cursor-pointer h-full w-1/4">
                ...
                <div data-link="{{ route('home') }}" class="chats nav-item {{ $active !== 'chats' ?: 'select-nav-item' }} flex justify-center items-center cursor-pointer h-full w-1/4">
