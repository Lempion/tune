            ...
            <div class="h-4/6 w-full bg-cover rounded-2xl z-10 shadow-inner shadow-gray-300 overflow-hidden" style="background-image: url('{{ asset('storage/images/bg-down-form-r.jpg') }}')">
                ...
                <div class="w-full h-full flex justify-center items-center relative">
                    ...
                    <form class="form-register z-10 w-full h-full flex flex-col justify-center items-center transition-all duration-200 opacity-100 relative">
                        ...
                        <div class="w-4/6 mb-8">
                            <input type="password" id="password" name="password" class="border-b-4 border-[#ffa983] rounded-none bg-gray-100/0 text-[#343d74] font-bold rounded-lg block w-full px-1.5 text-3xl focus:outline-0 focus:border-b-gray-700 hover:cursor-pointer" placeholder="Password" required>
